...
CREATE TABLE `tb_prestador_servicos` (
	...
	`endereco_prestador_servicos` varchar(255) NOT NULL,
	`tipo_servicos` varchar(255) NOT NULL,
	`valor_hora_prestador_servicos` DECIMAL(10,2) NOT NULL,
	`descricao_prestador_servicos` varchar(255) NOT NULL,
	`email_prestador_servicos` varchar(255) NOT NULL,
	`senha_prestador_servicos` varchar(255) NOT NULL,
