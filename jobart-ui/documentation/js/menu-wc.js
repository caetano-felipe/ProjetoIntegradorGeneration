...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">jobart-ui documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-0de4dd2c07e322db2dbf6dcc7f501e7f"' : 'data-target="#xs-components-links-module-AppModule-0de4dd2c07e322db2dbf6dcc7f501e7f"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-0de4dd2c07e322db2dbf6dcc7f501e7f"' :
                                            'id="xs-components-links-module-AppModule-0de4dd2c07e322db2dbf6dcc7f501e7f"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/CadastroProdutoComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">CadastroProdutoComponent</a>
                                            </li>
                                            <li class="link">
